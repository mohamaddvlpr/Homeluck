...
class SinglePage extends Template
{
  ...
  public function __construct()
  {
    ...
    if (!$this->request->has('id'))
      throw new NotFoundPage("We Dont Have Any Data");

    $id = $this->request->id;
    $homeModel = new Home();
    $this->homes = $homeModel->getDataById($id);
    $this->title = $this->setting->getTitle();

    Session::flush('message', 'Congratulation!');
  }
                        ...
                        <div class="card-body pt-50">
                          <div class="row">
                            <div class="col-md-4 col-sm-6">
                              <div class="card">
                                <div class="card-content">
                                  <img class="card-img-top img-fluid" src="<?= asset($this->homes->getImage()) ?>" alt="Card image cap">
                                  <div class="card-body">
                                    <h4 class="card-title"><?= $this->homes->getTitle() ?></h4>
                                    <p>
                                      <?= $this->homes->getDescription() ?>
                                    </p>
                                    <p class="card-text">
                                      آدرس : <?= $this->homes->getAddress() ?>
                                    </p>

                                    <p class="card-text" style="color: green;">
                                      قیمت : <?= $this->homes->getPrice() ?>
                                    </p>

                                    <p class="card-text" style="color: green;">
                                      ساخت سال : <?= $this->homes->getYearofConstruction() ?>
                                    </p>
                                    <form action="#" method="post">
                                      <a href="<?= url('index.php', ['action' => 'single', 'id' => $this->homes->getId()]) ?>" class="btn btn-success block">رهن خانه</a>
                                      <a href="<?= url('index.php', ['action' => 'single', 'id' => $this->homes->getId()]) ?>" class="btn btn-black block">خرید خانه</a>
                                    </form>
